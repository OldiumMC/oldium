...
public interface VertexBufferView {
     ...
     */
    boolean oldium$ensureBufferCapacity(int bytes);

    /**
     * Returns a handle to the internal storage of this buffer. The buffer can be directly written into at the
     * base address provided by {@link VertexBufferView#oldium$getWriterPosition()}.
     *
     ...
     */
    void oldium$flush(int vertexCount, BufferVertexFormat format);

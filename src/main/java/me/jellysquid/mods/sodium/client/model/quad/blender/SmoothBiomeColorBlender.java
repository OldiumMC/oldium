...
public class SmoothBiomeColorBlender implements BiomeColorBlender {
    ...
    private int getVertexColor(IBlockColor colorizer, BlockView world, BlockState state, BlockPos origin,
    ...
    private int getBlockColor(IBlockColor colorizer, BlockView world, BlockState state, BlockPos origin,
                              int x, int z, int colorIdx) {
        return colorizer.colorMultiplier(state, world, this.mpos.setPosition(x, origin.getY(), z), colorIdx);
    }

    private int getInterpolatedVertexColor(IBlockColor colorizer, BlockView world, BlockState state,
